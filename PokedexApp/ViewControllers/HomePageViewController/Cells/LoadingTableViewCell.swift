...
class LoadingTableViewCell: UITableViewCell {
    private var loaderView: AnimationView = AnimationView(name: "loader")
    ...
    private func configureConstraints() {
        ...
        let loaderConstraints: [NSLayoutConstraint] = [
            self.loaderView.topAnchor.constraint(equalTo: self.topAnchor, constant: 0),
            ...
            self.bottomAnchor.constraint(equalTo: self.loaderView.bottomAnchor, constant: 0),
            self.centerXAnchor.constraint(equalTo: self.loaderView.centerXAnchor),
            self.loaderView.heightAnchor.constraint(equalToConstant: 60)
        ]
